...
// channels — served INSIDE the Ops shell.
//
// The screen still lives at app/(site)/marketing/(hub)/channels/, which remains the
...
export const metadata: Metadata = {
  title: "Channels · Ops — Curbio",
  robots: { index: false, follow: false },
};

export { default } from "@/app/(site)/marketing/(hub)/channels/page";
