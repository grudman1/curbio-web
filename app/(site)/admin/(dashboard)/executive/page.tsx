...
// executive — served INSIDE the Ops shell.
//
// The screen still lives at app/(site)/marketing/(hub)/executive/, which remains the
...
export { default } from "@/app/(site)/marketing/(hub)/executive/page";
