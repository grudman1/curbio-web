...
// outreach — served INSIDE the Ops shell.
//
// The screen still lives at app/(site)/marketing/(hub)/outreach/, which remains the
...
export const metadata: Metadata = {
  title: "Outreach · Ops — Curbio",
  robots: { index: false, follow: false },
};

export { default } from "@/app/(site)/marketing/(hub)/outreach/page";
