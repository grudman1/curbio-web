...
// settings — served INSIDE the Ops shell.
//
// The screen still lives at app/(site)/marketing/(hub)/settings/, which remains the
...
export { default } from "@/app/(site)/marketing/(hub)/settings/page";
