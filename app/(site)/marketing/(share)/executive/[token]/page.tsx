...
import { ExecutiveReview } from "../../../(hub)/executive/ExecutiveReview";

// ─────────────────────────────────────────────────────────────────────────────
// /marketing/executive/[token] — presentation mode. The token is ONE
// env-configured string (MARKETING_EXEC_SHARE_TOKEN); there is deliberately
...
export default async function SharedExecutivePage({
  ...
  const expected = process.env.MARKETING_EXEC_SHARE_TOKEN;
