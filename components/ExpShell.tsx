...
// ── Hero eyebrow: Trusted Provider badge + market context ──
function ExpEyebrow({ market, neutral }: { market: CampaignMarket; neutral: boolean }) {
  return (
    ...
    <>
      ...
      <main>
        <Hero
          ...
          eyebrowContent={<ExpEyebrow market={market} neutral={neutral} />}
