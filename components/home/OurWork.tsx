...
export function OurWork() {
  return (
    <section className="dp-sect--work-gallery">
      <div className="dp-container">
        <h2 className="dp-h2 dp-work-h2">By address, not by adjective.</h2>
      </div>
      <div className="dp-work-feature">
        <div className="dp-work-featcopy">
      ...
      <div className="dp-container dp-work-gallery">
        {GALLERY.map((g) => (
          <figure key={g.addr} className={`dp-work-fig${g.mod}`}>
            <div className="dp-work-figimg" style={{ height: g.height }}>
              <Image
                src={g.src}
                alt={g.addr}
                fill
      ...
      <div className="dp-container dp-work-all">
        <span className="dp-ulink" style={{ fontSize: 16, fontWeight: 600 }}>
          All projects →
        </span>
      </div>
    </section>
